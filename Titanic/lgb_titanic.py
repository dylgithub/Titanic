...
#训练模型
model=lgb.LGBMClassifier(n_estimators=700,n_jobs=-1,subsample=0.8,learning_rate=0.007,max_depth=10,num_leaves=20)
model2=xgb.XGBClassifier(n_estimators=700,n_jobs=-1,subsample=0.8,learning_rate=0.007,max_depth=10,min_child_weight=3)
