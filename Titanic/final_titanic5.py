...
'''
相比于4这里进行模型融合,但是最终准确率为0.869还没不融合的高
'''
...
model1=GradientBoostingClassifier(n_estimators=700,learning_rate=0.007)
model2=RandomForestClassifier(n_estimators=700,max_depth=10)
model3=LogisticRegression()
model=xgb.XGBClassifier(n_estimators=700,n_jobs=-1,subsample=0.8,learning_rate=0.007,max_depth=10,min_child_weight=3)
model4=StackingClassifier(classifiers=[model1, model, model3],meta_classifier=model2)
